    ...
    <>
      <div className="flex items-center justify-between w-full">
        {/* <button
          ...
          className={
            'relative flex gap-[8px] items-center justify-centers focus:ring-primary/5'
          }
        >
...
export default function SortMenu() {
  ...
  return (
    <Menu as="div" className="relative z-40">
      ...
      <Menu.Items
        as="nav"
        className="absolute right-0 flex flex-col p-4 text-right rounded-[12px] bg-contrast border border-[#373737]"
      >
        {items.map((item) => (
