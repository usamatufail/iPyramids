...
export const Subscribe = () => {
  ...
  return (
    <section className="grid min-h-[400px] md:grid-cols-2 gap-[50px] items-center bg-[url('https://cdn.shopify.com/s/files/1/0771/2768/0277/files/mail-bg.png')] px-[20px] bg-cover bg-no-repeat py-[40px]">
