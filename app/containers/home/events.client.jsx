...
export const Event = () => {
  return (
    <section className="md:min-h-[630px] bg-[url('https://cdn.shopify.com/s/files/1/0771/2768/0277/files/event-bg.png')] bg-cover bg-no-repeat flex flex-col gap-[18px] justify-center items-center px-[20px] py-[40px]">
      <Animate>
