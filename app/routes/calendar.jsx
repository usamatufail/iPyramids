...
import {Info, Calender as CustomCalender} from '../containers';
...
export default function Calendar() {
  ...
  return (
    <Suspense>
      <div className="bg-[url('/info-bg.png')] bg-cover bg-no-repeat py-[50px] md:py-[50px] flex flex-col gap-[20px]">
        <Animate>
          <h1 className="text-[28px] md:text-[52px] font-[700] text-white text-center font-apple">
            Events To Take Part
          </h1>
        </Animate>
        <Animate>
